...
const Bio = () => {
  return (
    <div className='text-center lg:mr-3 lg:text-left lg:w-2/3 lg:ml-40'>
		...
		<p className='text-sky-500 font-semibold mr-1.5'>Soy un </p>
		<Typewriter 
			options={{
		...
		>
			...
			>
			que busca cada dia mejorar sus habiliadades, aprender nuevas tecnologias y enfrentar desafios para crecer profesionalmente en el ambito de la programacion.
		</p>
